...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="m-auto relative grid place-content-center min-h-screen md:max-w-[65vw] bg-gradient-to-b from-white to-yellow-300">
        ...
        <div className="z-20 grid grid-cols-2 gap-[320px] w-full py-5 -mt-28">
          ...
          <div className="w-full">
            <Image src="/photo3.png" width={300} height={300} />
            <div className="bg-green-800 text-white w-full p-3 rounded-xl text-center">
              <div className="text-xl ">
                M.RUSLI
                <br />
        ...
        <div className="z-20 grid place-content-center -mt-60 bottom-0">
          <Image src="/photo2.png" width={300} height={300} />
          <div className="bg-green-800 text-white w-full p-3 rounded-xl text-center">
            <div className="text-xl ">
              Ir. AIRLANGGA
              <br />
